...
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeB#foo --recreate-lock-file) = 2 ]]
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file) = 4 ]]
...
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file) = 3 ]]
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file --override-input b/c git+file://$flakeC2) = 4 ]]

# Test unused overrides detected
# A(override B.X=A, B.C.Y=A) -> B -> C
cat > $flakeA/flake.nix <<EOF
{
  inputs.b.url = git+file://$flakeB;
...
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo) = 3 ]]
...
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file 2>&1 | grep "unused override(s)") =~ $expectedOutputRegex ]]
...
# C + D = 2
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeC#foo --recreate-lock-file) = 2 ]]
# B + C + D2 = 4
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeB#foo --recreate-lock-file) = 4 ]]
# A + B + C + D3 = 6
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file) = 6 ]]
...
# C + D + E = 3
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeC#foo --recreate-lock-file) = 3 ]]
# B + C + D2 + E = 5
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeB#foo --recreate-lock-file) = 5 ]]
# A + B + C + D2 + E2 = 7
[[ $($NIX --experimental-features "flakes nix-command" eval $flakeA#foo --recreate-lock-file) = 7 ]]
